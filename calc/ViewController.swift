...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var displayRadDeg: UILabel!
    @IBOutlet weak var firstRow1: UIButton!
    @IBOutlet weak var firstRow2: UIButton!
    @IBOutlet weak var secondRow1: UIButton!
    @IBOutlet weak var secondRow2: UIButton!
    @IBOutlet weak var thirdRow1: UIButton!
    @IBOutlet weak var thirdRow2: UIButton!
    @IBOutlet weak var thirdRow3: UIButton!
    @IBOutlet weak var fourthRow1: UIButton!
    @IBOutlet weak var fourthRow2: UIButton!
    @IBOutlet weak var fourthRow3: UIButton!
    ...
    @IBAction func doUndoRedo(_ sender: UIButton) {
        for element in arrayUndoRedo {
            print(element)
        }
        let undoVariable = arrayUndoRedo.popLast() ?? Double("0.0")!
        displayValue = undoVariable
        brain.setOperand(undoVariable)
    }
}
